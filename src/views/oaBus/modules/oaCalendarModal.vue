    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        <a-form-item
          ...
          label="日程内容">
          <a-input placeholder="请输入日程内容" v-decorator="['stitle', {rules:[{required:true,message:'日程内容不能为空'},{ min: 0, max: 50, message: '日程内容不能超过50个汉字！', trigger: 'blur' }]}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="日程地点">
          <a-input placeholder="请输入日程地点" v-decorator="['saddress', {rules:[{ min: 0, max: 50, message: '日程地点不能超过50个汉字！', trigger: 'blur' }]}]"/>
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
