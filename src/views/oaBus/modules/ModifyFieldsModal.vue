  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form" v-for="(atom,index) in searchColumns" :key="index">
       <!--输入框-->
        <a-form-item v-if="atom.i_column_type==1||atom.i_column_type==2"   v-show="atom.s_table_column!='i_id'"
        :labelCol="labelCol"
        ...
        <!--下拉列表-->
        <!--<a-form-item v-if="atom.i_column_type==2" v-show="atom.s_table_column!='i_id'"-->
                     <!--:labelCol="labelCol"-->
                     <!--:wrapperCol="wrapperCol"-->
                     <!--:label="atom.s_column_name">-->
