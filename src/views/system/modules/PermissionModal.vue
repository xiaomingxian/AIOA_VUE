    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          :label="menuLabel"
          hasFeedback >
          <a-input :placeholder="'请输入'+menuLabel" v-decorator="[ 'name',  {rules:[{required:true,message:'请输入'+menuLabel+'!'},{ min: 0, max: 100, message: '菜单名称长度不能超过100位！', trigger: 'blur'  }] }]" :readOnly="disableSubmit"/>
        </a-form-item>
