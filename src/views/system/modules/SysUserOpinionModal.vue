      ...
      <a-form :form="form">
       ...
       <!-- <a-form-item
        ...
        <a-form-item
          ...
          :wrapperCol="wrapperCol"
          label="序号">
          <a-input style="width: 100px" placeholder="请输入序号" v-decorator="['iorder', {rules:[{required:true,message:'序号必须输入！！！'},{ min: 1, max: 10, message: '长度在 1 到 10 个字符', trigger: 'blur' },{pattern: new RegExp(/^[1-9]\d*$/), message: '请输入数字！'}]}]" />
        </a-form-item>
        <a-form-item
          :labelCol="labelCol"
          :wrapperCol="wrapperCol"
