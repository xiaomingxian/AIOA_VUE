<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator" style="border-top: 5px">
      ...
      <a-button v-has="'user:import'" type="primary" icon="download" @click="handleExportXls('用户信息')">导出</a-button>
      <a-upload name="file" :showUploadList="false" :multiple="false" :headers="tokenHeader" :action="importExcelUrl" @change="handleImportExcel">
        <a-button v-has="'user:export'" type="primary" icon="import">导入</a-button>
      </a-upload>
    ...
    <sys-user-managedepts-list ref="SysUserManagedeptsList"></sys-user-managedepts-list>
  </a-card>
</template>
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            width: 200,
            sorter: (i, ii, type) => {
              this.queryParam.orederBydepart = type == 'descend' ? -1 : 1;
              return true
            },
