...
<template>
  ...
  <a-card :bordered="false">
    <span class="table-page-search-submitButtons" :style="advanced && { overflow: 'hidden'} || {} ">
              <a-button class="tabb" type="primary">会议纪要</a-button>
              <a-button class="tabb" type="primary">会议申报</a-button>
              <a-button class="tabb" type="primary">会议通知</a-button>
              <a-button class="tabb" type="primary">会议回报</a-button>
              <a-button class="tabb" type="primary">会议室纪管理</a-button>
              <a-button class="tabb" type="primary">会议申请</a-button>
              <a-button class="tabb" type="primary">会议通知</a-button>
              <a-button class="tabb" type="primary">会议结果</a-button>
    </span>
      ...
      <a-form layout="inline">
        <a-row :gutter="48">
          ...
          <template v-if="advanced">
            ...
            <a-col :md="8" :sm="24" style="margin-left: 100px;">
            ...
            <a-col :md="8" :sm="24" style="margin-left: 200px;">
            ...
            <a-col :md="9" :sm="24" style="margin-left: 100px;">
              <a-form-item label="申请人">
                <a-input v-model="queryParam.id" placeholder=""/>
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="24" style="margin-left: 144px;">
