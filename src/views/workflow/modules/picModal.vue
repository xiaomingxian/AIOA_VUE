<template>
  ...
  <!--<a-modal-->
    ...
    <div  id="pic"  :style="{overflow: 'auto', position: 'relative',backgroundColor: '#ffffff',height: scrHeight}">

      <div style="width:100%">
        <!--@click='showPicFull'-->
        <img style="position:relative;left:50px;top:5px" :src="picurl"  v-if="visible"  />
